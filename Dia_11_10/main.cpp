...
{}
bool hash_enc_over_flow::excluir(char nome[])
{}
...
int main()
{
    ...
    do
    {
        ...
        printf("2    -   Exibe toda a lista\n");
        printf("3    -   Buscar um nome\n");
        printf("4    -   Consultar nomes com uma determinada letra\n");
        printf("5    -   excluir um nome\n");
        printf("0    -   Sair\n");
        scanf("%d",&op);
            ...
            switch (op)
            {
                ...
                case 5:
                        printf("Entre com um nome que quer excluir: ");
                        fflush(stdin);
                        gets(nome);
                        f.excluir(nome);
                        system("pause");
